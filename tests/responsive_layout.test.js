...
assert.ok(html.includes('continental-screen'), 'continental competitions should have a compact mobile table mode');
assert.ok(css.includes('.continental-screen table { min-width: 0;'), 'continental tables should fit the mobile viewport');
